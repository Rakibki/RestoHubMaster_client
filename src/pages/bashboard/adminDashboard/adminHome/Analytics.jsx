...
const Analytics = ({data}) => {
  return (
    <div className="grid gap-2 grid-cols-4">
          <div className="border-[1px] bg-white border-[#e2e8f0] hover:border-[#ffa41f] rounded-lg hover:shadow-xl p-6">
          ...
          <div className="border-[1px] bg-white transition-all border-[#e2e8f0] hover:border-[#ffa41f] rounded-lg hover:shadow-xl p-6">
            <h1 className="text-center text-[#ffa41f] font-semibold text-2xl">
