...
//               <h1
//                 data-aos="fade-up"
//                 className="md:text-6xl text-center text-3xl font-bold"
//               >
...
//                   <button
//                     data-aos="fade-up"
//                     className="border-[1px] font-semibold hover:border-none px-7 hover:bg-[#ffa41f] transition-all  rounded-sm border-[#fff] py-2"
//                   >
//                     OUR MENU
//                   </button>
//                   <button
...
//               <h1
//                 data-aos="fade-up"
//                 className="md:text-6xl text-center font-bold text-3xl"
//               >
//                 GOOD FOOD & GOOD HEALTH
//               </h1>
//               <p data-aos="fade-up" className="mt-4">
...
//               <h1
//                 data-aos="fade-up"
//                 className="text-3xl md:text-6xl text-center font-bold"
//               >
//                 GOOD FOOD & GOOD HEALTH
//               </h1>
//               <p data-aos="fade-up" className="mt-4">
